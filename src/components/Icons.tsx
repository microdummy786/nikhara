...
export const Logo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <img src={logoSvg} alt="NikharaBrief Logo" {...props} />
);
...
export const ErrorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line></svg>
);
...
export const ThreadsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.5 12.068c0-3.518.85-6.372 2.495-8.423C5.845 1.205 8.598.024 12.179 0h.007c3.581.024 6.334 1.205 8.184 3.509 1.645 2.051 2.495 4.905 2.495 8.423 0 3.518-.85 6.372-2.495 8.423C18.52 22.795 15.767 23.976 12.186 24zM12.186 1.5c-2.927.02-5.18.95-6.676 2.771-1.4 1.746-2.125 4.221-2.125 7.297 0 3.076.725 5.551 2.125 7.297 1.496 1.821 3.749 2.751 6.676 2.771h.007c2.927-.02 5.18-.95 6.676-2.771 1.4-1.746 2.125-4.221 2.125-7.297 0-3.076-.725-5.551-2.125-7.297C17.373 2.45 15.12 1.52 12.193 1.5h-.007z"/>
    <path d="M12.186 18.75c-3.518 0-6.375-2.857-6.375-6.375s2.857-6.375 6.375-6.375 6.375 2.857 6.375 6.375-2.857 6.375-6.375 6.375zm0-11.25c-2.69 0-4.875 2.185-4.875 4.875s2.185 4.875 4.875 4.875 4.875-2.185 4.875-4.875-2.185-4.875-4.875-4.875z"/>
    <path d="M12.186 15c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5zm0-3.75c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25z"/>
  </svg>
);
...
export const CrownIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="#FFB84D" {...props}>
    <path d="M528,448H112c-8.8,0-16,7.2-16,16v32c0,8.8,7.2,16,16,16h416c8.8,0,16-7.2,16-16v-32C544,455.2,536.8,448,528,448z M592,128	c-26.5,0-48,21.5-48,48c0,7.1,1.6,13.7,4.4,19.8L476,239.2c-15.4,9.2-35.3,4-44.2-11.6L350.3,85C361,76.2,368,63,368,48	c0-26.5-21.5-48-48-48s-48,21.5-48,48c0,15,7,28.2,17.7,37l-81.5,142.6c-8.9,15.6-28.9,20.8-44.2,11.6l-72.3-43.4	c2.7-6,4.4-12.7,4.4-19.8c0-26.5-21.5-48-48-48S0,149.5,0,176s21.5,48,48,48c2.6,0,5.2-0.4,7.7-0.8L128,416h384l72.3-192.8	c2.5,0.4,5.1,0.8,7.7,0.8c26.5,0,48-21.5,48-48S618.5,128,592,128L592,128z"></path>
  </svg>
);
