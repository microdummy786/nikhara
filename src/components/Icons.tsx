...
export const ThreadsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 192" fill="currentColor" {...props}>
        <path fill="currentColor" d="M141.537 88.988a66.667 66.667 0 0 0-2.518-1.143c-1.482-27.307-16.403-42.94-41.457-43.1h-.34c-14.986 0-27.449 6.396-35.12 18.036l13.779 9.452c5.73-8.695 14.724-10.548 21.348-10.548h.229c8.249.053 14.474 2.452 18.503 7.129 2.932 3.405 4.893 8.111 5.864 14.05-7.314-1.243-15.224-1.626-23.68-1.14-23.82 1.371-39.134 15.264-38.105 34.568.522 9.792 5.4 18.216 13.735 23.719 7.047 4.652 16.124 7.183 25.552 7.183 9.682 0 18.667-2.55 25.334-7.183 7.132-4.928 11.816-12.184 13.219-20.413 3.671 1.62 7.507 2.51 11.483 2.637 14.503.476 27.332-11.481 28.574-26.827 1.2-14.897-8.643-28.187-23.4-31.42Zm-40.9 74.58c-7.436 0-14.015-1.886-19.2-5.469-4.586-3.164-7.113-7.66-7.342-13.025-.446-8.322 6.105-16.18 23.115-17.084 1.95-.103 3.846-.155 5.695-.155 5.763 0 10.79.432 15.092 1.295-1.21 18.284-9.267 34.438-17.36 34.438Z"></path>
    </svg>
);
